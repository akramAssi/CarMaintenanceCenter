...
class Sample {
    final ObservableValue<Integer> id;
       ...
       SimpleStringProperty cudesc;
       SimpleStringProperty type;
       int x=5;

        Sample(int id,String status ,String cnowner, String cnmanuf,String cmodel,String year,String ctdes,String ctech,String type,String ctarrived,String ctstart,String ctend,String ctdel) {
            ...
            this.cudesc = new SimpleStringProperty(year);
